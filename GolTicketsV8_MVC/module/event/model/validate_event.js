...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "module/event/controller/controller_event.php?op=read_modal&modal=" + id,
            type: "GET",
            dataType: "json",
            success: function(response) {
                ...
                $("#event_description").html(response.event_description);
                $("#event_organization").html(response.event_organization);
                $("#event_date").html(response.event_date);
                $("#event_hour").html(response.event_hour);
                $("#event_place").html(response.event_place);
                $("#event_city").html(response.event_city);
                $("#event_duration").html(response.event_duration);
                $("#event_capacity").html(response.event_capacity);
                $("#event_price").html(response.event_price);
                $("#event_disponibility").html(response.event_disponibility);
                $("#event_local").html(response.event_local);
                $("#event_visitor").html(response.event_visitor);
                $("#state").html(response.event_state);
                $("#type").html(response.event_competition);
                $("#tickets").html(response.ticket_type);
                $("#services").html(response.event_services);

                $("#details_event").show();
                $("#event_modal").dialog({
                        width: 850, //<!-- ------------- ancho de la ventana -->
                        height: 850, //<!--  ------------- altura de la ventana -->

...
<form autocomplete="on" method="post" name="form_event" id="form_event">
...
<div class="checkbox-group">
  ...
  <div class="radio-group">
    ...
    <br><br>
    <tr>
        <td><input type="button" name="<?= $action?>" id="<?= $action?>"
                value="<?= $isUpdate ? 'Modificar' : 'Crear'?>" onclick="validate('<?= $action?>');"/></td>
        <td align="right"><a href="index.php?page=controller_event&op=list">Volver</a></td>
    </tr>
</div>

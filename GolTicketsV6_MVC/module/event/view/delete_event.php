<div id="contenido">
    <form autocomplete="on" method="post" name="delete_event" id="delete_event"
        action="index.php?page=controller_event&op=delete&id=<?= htmlspecialchars($_GET['id'] ?? '')?>">
        <table border='0'>
            <tr>
            ...
            <tr>
                <td align="center"><button type="submit" class="Button_green" name="delete" id="delete">Aceptar</button>
                </td>

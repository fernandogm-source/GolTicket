<?php
$path = $_SERVER['DOCUMENT_ROOT'] . '/GolTicketsV21_MVC/';
...
class DAOShop {
    ...
    function select_all_event($filter = [],$limit = " ",$offset = " ",$orderby = " ") {
        ...
        $sql .= " GROUP BY p.id_partido ORDER BY $orderby LIMIT $limit OFFSET $offset";

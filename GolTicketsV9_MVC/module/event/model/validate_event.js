...
function showModal(title, id) {
    ...
    $("#event_modal").dialog({
        ...
        buttons : {
            Update: function() {
                        window.location.href = 'index.php?page=controller_event&op=update&id=' + id;
                    },
            Delete: function() {
                        window.location.href = 'index.php?page=controller_event&op=delete&id=' + id;
                    }
        }
    });
}
...
function loadContentModal() {
    $('.event').click(function () {
        ...
        ajaxPromise('module/event/controller/controller_event.php?op=read_modal&modal=' + id, 'GET', 'JSON')
        .then(function(data) {
            //console.log(data);
            // console.log(data['user']);

            $('<div></div>').attr('id', 'details_event', 'type', 'hidden').appendTo('#event_modal');
            $('<div></div>').attr('id', 'container').appendTo('#details_event');
            $('#container').empty();
            $('<div></div>').attr('id', 'event_content').appendTo('#container');
            $('#event_content').html(function() {
                var content = "";
                for (row in data) {
                ...
                showModal(title = data.event_name, id = data.event_id);
        })
        .catch(function() {
